...
class Recipe(object):
    ...
    def _run(self):
        ...
        print(u"Creating the '{}' library in Plex...".format(self.recipe['new_library']['name']))
        try:
            ...
            if self.recipe['docker']['enabled']:
                self.plex.create_new_library(self.recipe['new_library']['name'], self.recipe['docker']['plex_folder'], self.library_type)
            else:
